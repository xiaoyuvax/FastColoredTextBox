...
namespace FastColoredTextBoxNS.Text
{
    public static class EncodingDetector
    {
        ...
        {
            return (c >= '\u3400' && c <= '\u4DB5') || // CJK Unified Ideographs Extension A
                   (c >= '\u4E00' && c <= '\u9FA5') || // CJK Unified Ideographs
                   (c >= '\u9FA6' && c <= '\u9FBB') || // CJK Unified Ideographs
                   (c >= '\uF900' && c <= '\uFA2D') || // CJK Compatibility Ideographs
                   (c >= '\uFA30' && c <= '\uFA6A') || // CJK Compatibility Ideographs
                   (c >= '\uFA70' && c <= '\uFAD9') || // CJK Compatibility Ideographs
                   (c >= '\uFF00' && c <= '\uFFEF') || // Fullwidth ASCII, Fullwidth Latin, Halfwidth Katakana, Halfwidth Hangul, etc.
                   ...
                   (c >= '\u3040' && c <= '\u309F') || // Hiragana
                   (c >= '\u30A0' && c <= '\u30FF') || // Katakana
                   (c >= '\xAC00' && c <= '\uD7AF') || // Hangul Syllables
                   (c >= '\u1100' && c <= '\u11FF');  // Hangul Jamo
            //Not supported yet: 
            //(c >= '\u20000' && c <= '\u2A6D6') || // CJK Unified Ideographs Extension B
            //(c >= '\u2F800' && c <= '\u2FA1D') || // CJK Compatibility Supplement
        }
