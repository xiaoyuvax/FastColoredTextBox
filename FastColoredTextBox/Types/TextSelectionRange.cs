...
namespace FastColoredTextBoxNS.Types
{
    ...
    public class TextSelectionRange : IEnumerable<Place>
    {
        ...
        public void GoWordLeft(bool shift)
        {
            ...
            TextSelectionRange range = Clone();//to OnSelectionChanged disable
            bool wasSpace = false;
        ...
        public IEnumerable<Place> GetPlacesCyclic(Place startPlace, bool backward = false)
        {
            if (backward)
            {
                var r = new TextSelectionRange(tb, startPlace, startPlace);
                ...
                r = new TextSelectionRange(tb, End, End);
            ...
            else
            {
                ...
                r = new TextSelectionRange(tb, Start, Start);
