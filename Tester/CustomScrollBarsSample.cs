...
namespace Tester {
	public partial class CustomScrollBarsSample : Form {
		...
		private void AdjustScrollbars() {
			AdjustScrollbar(vMyScrollBar, fctb.VerticalScroll.Maximum, fctb.VerticalScroll.Value);
		...
		private void Fctb_ScrollbarsUpdated(object sender, EventArgs e) => AdjustScrollbars();
		private void ScrollBar_Scroll(object sender, ScrollEventArgs e) => fctb.OnScroll(e, e.Type != ScrollEventType.ThumbTrack && e.Type != ScrollEventType.ThumbPosition);
	}
	...
	public class MyScrollBar : Control {
		...
		public virtual void OnScroll(ScrollEventType type = ScrollEventType.ThumbPosition) => Scroll?.Invoke(this, new ScrollEventArgs(type, Value, Orientation));
