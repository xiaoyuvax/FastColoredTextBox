...
namespace Tester {
	public partial class CustomTextSourceSample2 : Form {
		...
		private void TbLineFilter_TextChanged(object sender, EventArgs e) => (fctb.TextSource as TextSourceWithLineFiltering).LineFilterRegex = Regex.Escape(tbLineFilter.Text);
	}
